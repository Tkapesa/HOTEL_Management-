                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="w-10 h-10 bg-secondary-800 rounded-lg flex items-center justify-center hover:bg-primary-600 transition-colors group">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link to="/booking-help" className="text-gray-400 hover:text-white transition-colors">Booking Help</Link></li>
                            <li><Link to="/cancellation" className="text-gray-400 hover:text-white transition-colors">Cancellations</Link></li>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mb-6">
                            Subscribe to get special offers and travel inspiration delivered to your inbox.
                        </p>
                        <div className="space-y-4">
                            <div className="flex">
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 bg-secondary-800 text-white placeholder-gray-400 rounded-l-lg border border-secondary-700 focus:outline-none focus:ring-2 focus:ring-primary-500"
                                />
                                <button className="px-6 py-3 bg-primary-600 hover:bg-primary-700 rounded-r-lg transition-colors">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm text-gray-400">No spam, unsubscribe anytime</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm text-gray-400">Secure & Protected</span>
                            </div>
                        </div>
                    </div>
                </div>
